...
<?php
    ...
    $orderStatus = "SELECT order_status.name FROM order_status, orders WHERE orders.id='{$id}' AND orders.order_status=order_status.id"; 
    $stausQuery = mysqli_query($connection,$orderStatus); 
    $orderResult = mysqli_fetch_assoc($stausQuery); 
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        <strong>Order Status: <?php echo $orderResult['name']; ?></strong>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
